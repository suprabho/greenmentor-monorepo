...
export default function AiHubDev() {
  ...
  return (
    <div className="h-full overflow-y-auto px-4 py-6 lg:px-8">
      <div className="mx-auto max-w-4xl space-y-6">
        <PageHeader
          title="Agent dev harness"
          sub="Run a single ESG agent (esg-agents runtime via @gm/agents) with raw JSON input"
          action={
            <Link
              href="/ai-hub/cowork"
        ...
        <div className="text-[12px] font-semibold uppercase tracking-wide text-gray-400">Run a single agent</div>
