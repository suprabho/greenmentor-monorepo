 ...
 */
export function BundlePreview({ bundles }: { bundles: CatalogBundle[] }) {
          ...
          {bundles.map((bundle) => {
            ...
            return (
              <Link
                ...
                className="group flex flex-col overflow-hidden rounded-[10px] border border-gray-200 bg-white transition-[border-color,transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:border-green-700 hover:shadow-soft"
              >
