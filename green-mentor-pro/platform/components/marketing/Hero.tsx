      ...
      <Container width="wide" className="relative z-10 pt-6 pb-20 md:pt-42 md:pb-28">
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_minmax(320px,380px)]">
          ...
          >
            ...
            >
              Everything you need to build a career in{" "}
              <span className="text-green-500">sustainability — one platform.</span>
            </h1>

            <p className="mt-8 max-w-2xl text-left text-[20px] leading-relaxed text-white/85 md:text-[22px]">
              Expert-led courses and live coaching, an AI copilot for ESG
              reporting, a curated jobs board, and a 40,000+ member community —
              all in one Green Mentor Pro membership.
            </p>
