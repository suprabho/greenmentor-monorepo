  ...
  return (
    <div className="relative flex h-dvh min-h-[560px] flex-col overflow-hidden bg-teal-900 text-white font-[family-name:var(--font-manrope)]">
      {/* Wordmark device — the deck's giant outlined lockup, color-dodged so it
          picks up the neon tone against the dark teal. */}
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute top-[-14%] right-[-30%] z-0 size-[90vw] rounded-full md:top-[-18%] md:right-[-8%] md:size-[46vw]"
        style={{
          background:
            "radial-gradient(circle, rgba(7,216,98,0.22) 0%, rgba(7,216,98,0) 68%)",
        }}
      />
