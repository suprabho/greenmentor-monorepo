...
import { COUNTRIES, countryByIso, flagEmoji, DEFAULT_COUNTRY_ISO } from "@/lib/data/country-codes";
 ...
 *
 * The visible dial-code chip is `aria-hidden` decoration painted under a
 * transparent full-bleed <select>, so the native picker opens anywhere on the
 * control while screen readers get a single labelled combobox.
 */
