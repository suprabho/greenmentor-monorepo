/**
 * Read side of the Sustainalytics Material ESG Issues taxonomy for the platform
 * UI. All three surfaces are anon-readable `_public` views (migrations 0019 +
 * 0020), so reads go through the RLS-bound server client, like lib/webinars/repo.ts.
 *
