 ...
 *
 * NOTE: this module is a per-app COPY of @gm/platform's lib/msci/nic-crosswalk.ts
 * (same precedent as ./materiality-map.ts / lib/nic). Curated by hand in the
 * platform copy — edit there and re-copy here; the platform vitest suite
 * (lib/msci/nic-crosswalk.test.ts) is the canonical validator.
 *
