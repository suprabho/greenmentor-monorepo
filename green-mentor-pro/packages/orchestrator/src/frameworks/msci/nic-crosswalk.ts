 ...
 *
 * NOTE: this module is a per-package COPY of @gm/platform's lib/msci/nic-crosswalk.ts.
 * Curated by hand in the platform copy — edit there and re-copy here; the platform
 * vitest suite (lib/msci/nic-crosswalk.test.ts) is the canonical validator.
 */
